...
import py.com.pysistemas.sginmo.dominio.seguridad.Grupo;
import py.com.pysistemas.sginmo.dominio.seguridad.PermisoGrupo;
import py.com.pysistemas.sginmo.dominio.seguridad.UsuarioGrupo;
import py.com.pysistemas.sginmo.servicio.CatalogoService;
import py.com.pysistemas.sginmo.servicio.GrupoService;
...
public class GrupoBean implements Serializable {
    ...
    private Map<Long, py.com.pysistemas.sginmo.dominio.seguridad.Usuario> usuariosPorId = java.util.Map.of();
    ...
    private void cargarUsuarios() {
        var mapa = new java.util.LinkedHashMap<Long, py.com.pysistemas.sginmo.dominio.seguridad.Usuario>();
    ...
    public java.util.Collection<py.com.pysistemas.sginmo.dominio.seguridad.Usuario> getUsuarios() {
