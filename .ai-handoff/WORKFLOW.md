...
7. Auditor lee REQs asignados desde `sp_siguiente_accion_agente('SGI', 'codex')`, revisa código real y rellena `codex-review.md`.
...
2. No mezclar en el mismo lote cambios criticos de datos, montos, cuotas, cobros o seguridad con cambios triviales.
...
Codex debe empezar por este manifiesto y luego decidir si necesita abrir diffs, archivos del REQ o codigo. Para riesgo bajo y evidencia suficiente, puede auditar con lectura reducida. Para riesgo medio/alto, datos, montos, cuotas, cobros, liquidaciones o seguridad, debe revisar evidencia completa.
...
| alto | Codex obligatorio | datos, montos, cuotas, cobros, liquidaciones, seguridad, autenticacion, migraciones/ETL |
